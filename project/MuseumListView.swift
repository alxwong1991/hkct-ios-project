                ...
                List() {
                    ForEach(bookmarkItems) {
                        bm in NavigationLink() {
                            ...
                            VStack {
                                Text((bm.museum_name != nil ? bm.museum_name! : "")).frame(maxWidth: .infinity, alignment: .leading).padding(EdgeInsets(top: 0, leading: 0, bottom: 0, trailing: 0))
                                Text("Is it gov owned: " + (bm.museum_isgov == true ? "Yes" : "No")).frame(maxWidth: .infinity, alignment: .leading).padding(EdgeInsets(top: 0, leading: 0, bottom: 0, trailing: 0))
                            }
                        }
                    }
                }
